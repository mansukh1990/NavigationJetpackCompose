package com.example.typesafenavigation.todoappwithfirebase.todo.data.repository

import com.example.typesafenavigation.todoappwithfirebase.todo.data.mapper.toToDoDTO
import com.example.typesafenavigation.todoappwithfirebase.todo.data.model.ToDoDTO
import com.example.typesafenavigation.todoappwithfirebase.todo.domain.mapper.toToDoUI
import com.example.typesafenavigation.todoappwithfirebase.todo.domain.model.ToDoUI
import com.example.typesafenavigation.todoappwithfirebase.todo.domain.repository.ToDoRepository
